...
use gpui::{
    actions, canvas, div, fill, font, point, prelude::*, px, size,
    uniform_list, App,
...
use gpui_component::{
    ...
    tag::Tag,
    IconName, Root, Rope, RopeExt as _, Sizable as _, TitleBar,
};
...
use cached_prs::{git_env, scan_cached_prs, CachedPr};
use subscriptions::{
