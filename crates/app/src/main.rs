...
use comments::{comment_anchor, comment_row, comment_wrap_cols, CommentSide, CommentThread, LocalReview};
...
mod tests {
    use super::*;
    use comments::{group_comments, CommentIndex, COMMENT_WRAP_CHARS};
    use diff::{
