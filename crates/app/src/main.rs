...
use diff_core::{FileDiff, FileStatus, PrDiff};
...
use comments::{
    comment_anchor, comment_row, comment_wrap_cols, group_comments, CommentIndex, CommentSide,
    CommentThread, LocalReview, COMMENT_WRAP_CHARS,
};
use selection::{row_selection_range, selection_info, selection_text, RowCol, SelSide, Selection};

use minimap::{
    minimap_rows, minimap_runs, minimap_scale, MinimapColor, MinimapLane, MinimapLayout,
    MinimapRow, MINIMAP_GAP, MINIMAP_PAD, MINIMAP_WIDTH,
};
use tree::{
...
pub(crate) use diff::{
    build_rows, is_comment_row, kind_style, line_content, nth_noncomment_row, row_height,
    run_upgrade, text_size, Cell, CardEdge, FileUpgrade, LineKind, Row, UpgradeJob, UpgradeSource,
...
pub(crate) mod test_util {
    use super::*;
    use diff_core::{DiffRow, FileDiff, Hunk};
...
mod tests {
    use super::*;
    use diff::{gap_span, hunk_syntax, merge_highlights, row_height_for};
    use diff_core::{diff_texts, FileDiff};
    use gpui::HighlightStyle;
    use minimap::MinimapKind;
