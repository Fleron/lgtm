    ...
    Application::new()
        ...
        .run(move |cx: &mut App| {
            ...
            cx.bind_keys([
                ...
                KeyBinding::new("j", LineDown, Some("ReviewApp")),
                KeyBinding::new("k", LineUp, Some("ReviewApp")),
                KeyBinding::new("down", LineDown, Some("ReviewApp")),
                KeyBinding::new("up", LineUp, Some("ReviewApp")),
                ...
                KeyBinding::new("cmd-r", TrackerRefresh, Some("Tracker")),
